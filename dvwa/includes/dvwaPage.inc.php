...
function dvwaHtmlEcho( $pPage ) {
	...
	if( dvwaIsLoggedIn() ) {
		...
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'exec', 'name' => 'Network Diagnostics', 'url' => 'vulnerabilities/exec/' );
		...
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'xss_r', 'name' => 'Change Name', 'url' => 'vulnerabilities/xss_r/' );
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'upload', 'name' => 'Profile Picture', 'url' => 'vulnerabilities/upload/' );
		...
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'xss_s', 'name' => 'Open Ticket', 'url' => 'vulnerabilities/xss_s/' );
	...
	<body class=\"home\">
		<div id=\"container\">
			...
			<div id=\"header\">
				...
				<img src=\"" . DVWA_WEB_PAGE_TO_ROOT . "dvwa/images/logo.png\" alt=\"Insecur3 System Admin Panel\" />
			...
			<div id=\"footer\">
				...
				<p>Insecur3 Systems Inc. v" . dvwaVersionGet() . "</p>
